var myQuestions = [
  ...
  {
    question:
      " Which country has the highest minimum drinking age in the world? ",
    answers: {
      a: "USA",
      b: "France",
      c: "Germany",
  ...
  {
    question:
      " How many kilos of cacahuètes are produced every second in the world? ",
    answers: {
      a: "550",
      b: "1820",
      c: "2200",
  ...
  {
    question:
      " People with which color of eyes stand have a greater alcohol tolerance? ",
    answers: {
      a: "Green",
      b: "Blue",
      c: "Brown",
  ...
  {
    question:
      " What is the % of French people having at least 1 apéro per week? ",
    answers: {
      a: "33%",
      b: "47%",
      c: "65%",
  ...
  {
    question:
      " Which is the country where people consume the most alcohol per year? ",
    answers: {
      a: "Latvia",
      b: "Ireland",
      c: "Germany",
  ...
  {
    question:
      " True or false: the ice melting does not make the liquid overflow from the glass ",
    answers: {
  ...
  {
    question:
      " How long does it take for the brain to start reacting to alcohol? ",
    answers: {
      a: "2 minutes",
      b: "6 minutes",
      c: "14 minutes",
